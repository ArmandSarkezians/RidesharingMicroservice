...
public class Endpoint implements HttpHandler {
    ...
    /**
     * This function sends the request to Utils, to be sent to each endpoint
     *
     * @param r the HTTPExchange send by the user
     */
    public void handle(HttpExchange r){
        try{
            JSONObject body = Utils.getBody(r);
            HttpResponse<String> response = Utils.sendRequest(this.url + r.getRequestURI().toString(), r.getRequestMethod(), body.toString());
